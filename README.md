...
![image](https://github.com/user-attachments/assets/3ee04b75-aefd-43ec-8d6b-f9a67df7511c)

 
 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/0bccbf30-2eeb-4ddb-aa7d-573d77e699a8)


## DUTY CYCLE AND FREQUENCY CALCULATION 
FOR PULSE AT 250
![image](https://github.com/user-attachments/assets/716646f8-02f5-4fa5-9055-eeccfe128183)
...
```
FOR PULSE AT 500
![image](https://github.com/user-attachments/assets/af674a97-05d9-439c-a0c0-c9eea4f57617)
```
TON = 3 * 10 * 10^-6
    = 0.00003
TOFF= 3 * 10 * 10^-6
...
FOR PULSE AT 700
![image](https://github.com/user-attachments/assets/45a56ea9-ccbe-4de5-852d-0f0b33cd2370)
```
TON = 4.5 * 10 * 10^-6
    = 0.000045
TOFF= 1.5 * 10 * 10^-6
